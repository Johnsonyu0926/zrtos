...
static int i2c_omap_transfer_message_ll(const struct device *dev)
{
	...
	data->cmd_err = 0; /* Clear any previous error */
	do {
		...
		if (stat & (I2C_OMAP_STAT_ARDY | I2C_OMAP_STAT_NACK | I2C_OMAP_STAT_AL)) {
			i2c_base_addr->STAT = I2C_OMAP_STAT_RRDY | I2C_OMAP_STAT_RDR |
		...
		if (stat & (I2C_OMAP_STAT_RRDY | I2C_OMAP_STAT_RDR)) {
			...
			i2c_base_addr->STAT = (stat & I2C_OMAP_STAT_RRDY) ? I2C_OMAP_STAT_RRDY
									  : I2C_OMAP_STAT_RDR;
			continue;
		}
		...
		if (stat & (I2C_OMAP_STAT_XRDY | I2C_OMAP_STAT_XDR)) {
			int buffer = (stat & I2C_OMAP_STAT_XRDY) ? i2c_base_addr->BUF
								 : i2c_base_addr->BUFSTAT;
			i2c_omap_transmit_receive_data(dev, buffer);
			i2c_base_addr->STAT = (stat & I2C_OMAP_STAT_XRDY) ? I2C_OMAP_STAT_XRDY
									  : I2C_OMAP_STAT_XDR;
			continue;
		}
				     ...
				     uint16_t addr)
{
	...
	if (result & (I2C_OMAP_STAT_AL | I2C_OMAP_STAT_NACK | -EAGAIN)) {
